        ...
        style: function(feature) {
            ...
            switch (feature.properties.REMARK) {
                ...
                case 'Permukiman dan Tempat Kegiatan': 
                    return {
                        fillColor: "rgb(191, 159, 241)", // Light Pink untuk permukiman sesuai gambar
                        fillOpacity: 0.8, 
                        weight: 0.5, 
                        color: "#8B0000"
                    };
                case 'Sawah': 
                    return {
                        fillColor: "rgb(159, 241, 231)", // Cyan untuk sawah sesuai gambar
                        fillOpacity: 0.8, 
                        weight: 0.5, 
                        color: "#008B8B"
                    };
...
const overlayMaps = {
    ...
    "Batas Kelurahan": adminKelurahanAR,
    "Jembatan": jembatanPT
};
